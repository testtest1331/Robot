...
class TunerConstants:
    ...
    _front_left_encoder_id = 62
    _front_left_encoder_offset: units.rotation = -0.351318359375
    _front_left_steer_motor_inverted = True
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(11.1)
    _front_left_y_pos: units.meter = inchesToMeters(11.1)

    # Front Right
    _front_right_drive_motor_id = 7
    _front_right_steer_motor_id = 8
    _front_right_encoder_id = 61
    _front_right_encoder_offset: units.rotation = -0.1513671875
    _front_right_steer_motor_inverted = True
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(11.1)
    _front_right_y_pos: units.meter = inchesToMeters(-11.1)

    # Back Left
    _back_left_drive_motor_id = 1
    _back_left_steer_motor_id = 2
    _back_left_encoder_id = 59
    _back_left_encoder_offset: units.rotation = 0.295166015625
    _back_left_steer_motor_inverted = True
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-11.1)
    _back_left_y_pos: units.meter = inchesToMeters(11.1)

    # Back Right
    _back_right_drive_motor_id = 5
    _back_right_steer_motor_id = 6
    _back_right_encoder_id = 60
    _back_right_encoder_offset: units.rotation = -0.060302734375
    _back_right_steer_motor_inverted = True
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-11.1)
    _back_right_y_pos: units.meter = inchesToMeters(-11.1)
